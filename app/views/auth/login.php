					...
					<div class="row">
						<div class="col-lg-12 p-5">
							<div class="">
								...
								if($this->session->flashdata('INVALID_METHOD')){
									echo '
									<div class="alert alert-danger alert-dismissible fade show" role="alert">
									<button type="button" class="close" data-dismiss="alert" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									...
									<strong><i class="fa fa-heart-broken" style="color:red;"></i> Error!</strong> '.$this->session->flashdata('INVALID_METHOD').'
								</div>';
								}
								if($this->session->flashdata('unauthorized')){
									echo '
									<div class="alert alert-danger alert-dismissible fade show" role="alert">
									<button type="button" class="close" data-dismiss="alert" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									...
									<strong><i class="fa fa-heart-broken" style="color:red;"></i> Error!</strong> '.$this->session->flashdata('unauthorized').'
								</div>';
								}
								...
								?>
								<form class="user" method='post' action='<?php echo base_url();?>auth/doLogin'>
								<?php
										$csrf = array(
								...
								<input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
									<div class="form-group">
										<input type="text" value="<?php echo set_value('username');?>" required class="form-control form-control-user" name='username' placeholder="Username">
									</div>
									<div class="form-group">
